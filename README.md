...
| `playlistsFile` | `./playlists.json`    | File for playlists to be stored in. Must be atomically-writable (don't map specifically this file in docker, map the parent folder)    |
